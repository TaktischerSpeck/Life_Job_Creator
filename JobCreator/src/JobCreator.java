...
public class JobCreator {
	...
	private boolean is_illegal, is_illegal_item, is_illegal_item2, is_edi, is_edi2;
	...
	private JCheckBox cb_is_edi;
	private JCheckBox cb_is_edi2;
	...
	private void initialize() {
		...
		cb_is_edi = new JCheckBox("Essbar?");
		cb_is_edi.setFont(new Font("Arial", Font.BOLD, 13));
		cb_is_edi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (cb_is_edi.isSelected() == true) {
					is_edi = true;
				}
				
				if (cb_is_edi.isSelected() == false) {
					is_edi = false;
				}
			}
		});
		cb_is_edi.setBounds(417, 490, 113, 25);
		frmItemcreatorVBy.getContentPane().add(cb_is_edi);
		
		cb_is_edi2 = new JCheckBox("Essbar?");
		cb_is_edi2.setFont(new Font("Arial", Font.BOLD, 13));
		cb_is_edi2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (cb_is_edi2.isSelected() == true) {
					is_edi2 = true;
				}
				
				if (cb_is_edi2.isSelected() == false) {
					is_edi2 = false;
				}
			}
		});
		cb_is_edi2.setBounds(560, 490, 113, 25);
		frmItemcreatorVBy.getContentPane().add(cb_is_edi2);
	...
	void gather () throws IOException {
		...
		int amount, zone_range, liz_price, anzahl_up, anzahl_p, no_lic_cost, sellPrice, buyPrice, weight, edible2, sellPrice2, buyPrice2, weight2;
